...
class Radical extends Nodebase {
  ...
  if (numLayers == 1) {
    ...
    switch (r) {
      ...
      leftright(_p, _q);
      getChild(1).topbottom(_p, _q);
       getChild(0).setPosition(new PVector(-10, 40));
      getChild(1).setPosition(new PVector(75, 40));
      getChild(1).getChild(1).leftright(_s,_q);
      break;
      case (1): 
      leftright(_s, _p);
      getChild(1).leftright(_p, _q);
         getChild(0).setPosition(new PVector(-10, 40));
      getChild(1).setPosition(new PVector(75, 40));
      break;
      case (2):  
      topbottom(_s, _m);
      getChild((int)random(0, 2)).leftright(_p, _q);
      break;
      case (3):  
      topbottom(_s, _q);
      getChild((int)random(0, 2)).topbottom(_p, _q);
      break;
      ...
      getChild(1).leftright(_m, _q);
      break;
      case (6):  
      allaround(_p, _s);
      getChild(1).topbottom(_m, _q);
      break;
      case (7):  
      bottomup(_p, _s);
      getChild(1).topbottom(_m, _q);
